            ...
            <li class="nav-item dropdown pe-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    <li class="dropdown-header">
                        <h6 class="d-none d-md-block dropdown-toggle ps-2 text-primary">{{ Auth::user()->role }}</h6>
                        <span class="d-none d-md-block dropdown-toggle ps-2 text-secondary">{{ Auth::user()->email }}</span>
                    </li>
                </ul>
            </li>
        </ul>
