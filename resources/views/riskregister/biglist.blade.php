    ...
    <div class="card text-center">
        <div class="card-body">
            <h5 class="card-title" style="font-size: 25px; font-weight: 700; letter-spacing: 2px;">
                REPORT RISK & OPPORTUNITY REGISTER
            </h5>
        </div>
    </div>

<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#filterModal" style="font-size: 15px;">Filter Options</button>
<br>
